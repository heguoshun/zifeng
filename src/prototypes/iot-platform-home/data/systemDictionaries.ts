...
export function createInitialDictionaries(): DictTypeRecord[] {
    return [
        ...
        },
        {
            ...
            items: [
                { id: 'item-mm-1', name: '紫峰装备', dataValue: '紫峰装备', description: '', sort: 1, enabled: true },
                { id: 'item-mm-2', name: '宁水表业', dataValue: '宁水表业', description: '', sort: 2, enabled: true },
                { id: 'item-mm-3', name: '三川智慧', dataValue: '三川智慧', description: '', sort: 3, enabled: true },
                { id: 'item-mm-4', name: '新天科技', dataValue: '新天科技', description: '', sort: 4, enabled: true },
                { id: 'item-mm-5', name: '威胜集团', dataValue: '威胜集团', description: '', sort: 5, enabled: true },
            ],
        },
        {
