...
function buildInitialMenus(): SystemMenuRecord[] {
    const menus: SystemMenuRecord[] = [
        ...
        seed('menu-message-center', {
            ...
            path: '/message-center',
            component: 'layouts/RouteView',
            redirect: '/message-center/alarm-info',
            icon: 'notification',
            sort: 3,
            menuType: 'root',
            isRoute: true,
        ...
        seed('menu-alarm-info', {
            parentId: 'menu-message-center',
            name: '设备告警信息',
            path: '/message-center/alarm-info',
            component: 'message/AlarmInfo',
            icon: 'alert',
            sort: 1,
            menuType: 'submenu',
            isRoute: true,
        ...
        seed('menu-alarm-rule', {
            parentId: 'menu-message-center',
            name: '告警规则配置',
            path: '/message-center/alarm-rule',
            component: 'message/AlarmRule',
            icon: 'setting',
            sort: 2,
            menuType: 'submenu',
            isRoute: true,
        ...
        seed('menu-alarm-level', {
            parentId: 'menu-message-center',
            name: '告警等级管理',
            path: '/message-center/alarm-level',
            component: 'message/AlarmLevel',
            icon: 'flag',
            sort: 3,
            menuType: 'submenu',
            isRoute: true,
        ...
        seed('menu-login-log', {
            parentId: 'menu-om-mgmt',
            name: '登录日志',
            path: '/om-mgmt/login-log',
            component: 'om/LoginLog',
            icon: 'login',
            sort: 4,
            menuType: 'submenu',
            isRoute: true,
        ...
        seed('menu-operation-log', {
            parentId: 'menu-om-mgmt',
            name: '操作日志',
            path: '/om-mgmt/operation-log',
            component: 'om/OperationLog',
            icon: 'audit',
            sort: 5,
            menuType: 'submenu',
            isRoute: true,
