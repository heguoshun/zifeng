...
/** 按产品分类划分的全局数据域；与告警规则分类根节点对应，并作用于设备、工单等业务数据 */
export type AlarmRuleCategoryScope =
    | 'large-meter'
    | 'household-meter'
    | 'pressure'
    | 'water-quality'
...
export const ALARM_RULE_SCOPE_LABELS: Record<AlarmRuleCategoryScope, string> = {
    'large-meter': '大表',
    'household-meter': '户表',
    pressure: '压力计',
    'water-quality': '水质分析仪',
...
export const ALARM_RULE_CATEGORY_SCOPES: AlarmRuleCategoryScope[] = [
    'large-meter',
    'household-meter',
    'pressure',
    'water-quality',
...
export const ALARM_RULE_SCOPE_ROOT_CATEGORY_IDS: Record<AlarmRuleCategoryScope, string> = {
    'large-meter': 'cat-large-meter',
    'household-meter': 'cat-household-meter',
    pressure: 'cat-pressure',
    'water-quality': 'cat-water-quality',
    'smart-station': 'cat-smart-station',
};
...
export function formatAlarmRuleScopeSummary(
    ...
    return scopes.map((scope) => ALARM_RULE_SCOPE_LABELS[scope]).join('、');
}
...
export function getAlarmRuleRootCategoryIdsForRole(role: {
    ...
    return role.alarmRuleCategoryScopes.map((scope) => ALARM_RULE_SCOPE_ROOT_CATEGORY_IDS[scope]);
}
...
export function createInitialRoles(): SystemRoleRecord[] {
    return [
        ...
        },
        {
            ...
            alarmRuleCategoryScopes: ['large-meter'],
        ...
        },
        {
            ...
            alarmRuleCategoryScopes: ['household-meter'],
            authorizedPermissionIds: [
                ...WORKBENCH_VIEW,
                ...DEVICE_ACCESS_VIEW,
                ...ALARM_WORK_ORDER_VIEW,
